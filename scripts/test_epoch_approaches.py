...
print('\nVerify:')
from_utc = datetime.fromtimestamp(utc_epoch, tz=ZoneInfo('UTC')).astimezone(ZoneInfo('America/Chicago'))
...
print(f'Approach 2 converts back to: {from_local.strftime("%Y-%m-%d %I:%M %p")} (should be 7:00 PM)')
